...
CopyFile(PChar('map\force_map1.gat'), PChar('map\force_4-1.gat'),True);  //kRO is starting the arena system? 9/6.04
...
CopyFile(PChar('map\quiz_01.gat'), PChar('map\guild_room.gat'),True);
...
CopyFile(PChar('map\pvp_room.gat'), PChar('map\pvp_c_room.gat'),True);
...
CopyFile(PChar('map\prt_maze02.gat'), PChar('map\pvp_n_6-1.gat'),True);
CopyFile(PChar('map\job_hunter.gat'), PChar('map\pvp_n_6-2.gat'),True);
CopyFile(PChar('map\job_wizard.gat'), PChar('map\pvp_n_6-3.gat'),True);
CopyFile(PChar('map\job_priest.gat'), PChar('map\pvp_n_6-4.gat'),True);
CopyFile(PChar('map\job_knight.gat'), PChar('map\pvp_n_6-5.gat'),True);
CopyFile(PChar('map\prt_maze02.gat'), PChar('map\pvp_n_7-1.gat'),True);
CopyFile(PChar('map\job_hunter.gat'), PChar('map\pvp_n_7-2.gat'),True);
CopyFile(PChar('map\job_wizard.gat'), PChar('map\pvp_n_7-3.gat'),True);
CopyFile(PChar('map\job_priest.gat'), PChar('map\pvp_n_7-4.gat'),True);
CopyFile(PChar('map\job_knight.gat'), PChar('map\pvp_n_7-5.gat'),True);
CopyFile(PChar('map\prt_maze02.gat'), PChar('map\pvp_n_8-1.gat'),True);
CopyFile(PChar('map\job_hunter.gat'), PChar('map\pvp_n_8-2.gat'),True);
CopyFile(PChar('map\job_wizard.gat'), PChar('map\pvp_n_8-3.gat'),True);
CopyFile(PChar('map\job_priest.gat'), PChar('map\pvp_n_8-4.gat'),True);
CopyFile(PChar('map\job_knight.gat'), PChar('map\pvp_n_8-5.gat'),True);
...
CopyFile(PChar('map\prontera.gat'), PChar('map\pvp_y_6-1.gat'),True);
CopyFile(PChar('map\izlude.gat'), PChar('map\pvp_y_6-2.gat'),True);
CopyFile(PChar('map\payon.gat'), PChar('map\pvp_y_6-3.gat'),True);
CopyFile(PChar('map\alberta.gat'), PChar('map\pvp_y_6-4.gat'),True);
CopyFile(PChar('map\morocc.gat'), PChar('map\pvp_y_6-5.gat'),True);
CopyFile(PChar('map\prontera.gat'), PChar('map\pvp_y_7-1.gat'),True);
CopyFile(PChar('map\izlude.gat'), PChar('map\pvp_y_7-2.gat'),True);
CopyFile(PChar('map\payon.gat'), PChar('map\pvp_y_7-3.gat'),True);
CopyFile(PChar('map\alberta.gat'), PChar('map\pvp_y_7-4.gat'),True);
CopyFile(PChar('map\morocc.gat'), PChar('map\pvp_y_7-5.gat'),True);
CopyFile(PChar('map\prontera.gat'), PChar('map\pvp_y_8-1.gat'),True);
CopyFile(PChar('map\izlude.gat'), PChar('map\pvp_y_8-2.gat'),True);
CopyFile(PChar('map\payon.gat'), PChar('map\pvp_y_8-3.gat'),True);
CopyFile(PChar('map\alberta.gat'), PChar('map\pvp_y_8-4.gat'),True);
CopyFile(PChar('map\morocc.gat'), PChar('map\pvp_y_8-5.gat'),True);
...
CopyFile(PChar('map\job_wizard.gat'), PChar('map\wizard_1-1.gat'),True);
CopyFile(PChar('map\job_wizard.gat'), PChar('map\wizard_2-1.gat'),True);
CopyFile(PChar('map\job_wizard.gat'), PChar('map\wizard_3-1.gat'),True);
